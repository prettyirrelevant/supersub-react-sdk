import { UserOperationCallData, BatchUserOperationCallData } from '@alchemy/aa-core';
...
declare const publicClient: {
    ...
    prepareTransactionRequest: <const TRequest extends import("viem").PrepareTransactionRequestRequest<{
        ...
        chainId?: number | undefined;
    }, (TRequest["parameters"] extends readonly import("viem").PrepareTransactionRequestParameterType[] ? TRequest["parameters"][number] : "fees" | "chainId" | "nonce" | "gas" | "blobVersionedHashes" | "type") extends infer T_47 ? T_47 extends (TRequest["parameters"] extends readonly import("viem").PrepareTransactionRequestParameterType[] ? TRequest["parameters"][number] : "fees" | "chainId" | "nonce" | "gas" | "blobVersionedHashes" | "type") ? T_47 extends "fees" ? "maxFeePerGas" | "maxPriorityFeePerGas" | "gasPrice" : T_47 : never : never> & (unknown extends TRequest["kzg"] ? {} : Pick<TRequest, "kzg">) extends infer T_25 ? { [K_1 in keyof T_25]: (import("viem").UnionRequiredBy<Extract<import("viem").UnionOmit<import("viem").ExtractChainFormatterParameters<import("viem").DeriveChain<import("viem").Chain, TChainOverride_2>, "transactionRequest", import("viem").TransactionRequest>, "from"> & (import("viem").DeriveChain<import("viem").Chain, TChainOverride_2> extends infer T_26 ? T_26 extends import("viem").DeriveChain<import("viem").Chain, TChainOverride_2> ? T_26 extends import("viem").Chain ? {
        chain: T_26;
    } : {
        chain?: undefined;
        ...
        chainId?: number | undefined;
    }, (TRequest["parameters"] extends readonly import("viem").PrepareTransactionRequestParameterType[] ? TRequest["parameters"][number] : "fees" | "chainId" | "nonce" | "gas" | "blobVersionedHashes" | "type") extends infer T_36 ? T_36 extends (TRequest["parameters"] extends readonly import("viem").PrepareTransactionRequestParameterType[] ? TRequest["parameters"][number] : "fees" | "chainId" | "nonce" | "gas" | "blobVersionedHashes" | "type") ? T_36 extends "fees" ? "maxFeePerGas" | "maxPriorityFeePerGas" | "gasPrice" : T_36 : never : never> & (unknown extends TRequest["kzg"] ? {} : Pick<TRequest, "kzg">))[K_1]; } : never>;
...
export declare class PluginClient {
    ...
    execute(param: UserOperationCallData | BatchUserOperationCallData): Promise<`0x${string}`>;
